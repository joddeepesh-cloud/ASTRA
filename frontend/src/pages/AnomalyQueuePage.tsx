        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold font-serif-display text-white tracking-wider uppercase flex items-center gap-2.5">
              <ShieldAlert className="w-5 h-5 text-rose-400" /> ANOMALY & PRIORITY QUEUE
            </h1>
            <span className="text-xs font-mono-tech bg-[#21133B] text-rose-300 border border-rose-500/40 px-2 py-0.5 rounded font-bold">
              TRIAGE CONSOLE
            </span>
          </div>
                    ...
                    <React.Fragment key={obs.id}>
                      <tr className={`transition-colors ${isExpanded ? 'bg-[#15102A]/80' : 'hover:bg-[#15102A]/40'}`}>
                        <td className="p-3.5 font-bold text-white flex items-center gap-2">
                          <span className={`w-2 h-2 rounded-full ${obs.priority === 'CRITICAL' ? 'bg-[#9B7FD4]' : 'bg-rose-400'}`} />
                          {obs.id}
                        </td>
                        <td className="p-3.5 text-[#D8D3E2]">
                        ...
                        <td className="p-3.5">
                          <span className="px-2 py-0.5 rounded bg-[#0D0A1C] text-[#8FD3FF] border border-[#21133B] font-semibold">
                            {expResult.interpretation.morphology}
                          </span>
                        </td>
                        <td className="p-3.5 text-center font-bold">
                          <span className={obs.anomaly_score >= 0.7 ? 'text-[#9B7FD4] font-extrabold' : 'text-rose-400'}>
                        ...
                        <td className="p-3.5 max-w-xs">
                          <button
                            ...
                            title="View ANOMALY interpretation"
                          >
